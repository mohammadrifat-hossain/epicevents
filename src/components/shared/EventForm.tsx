            ...
            try {
                const updatedEvent = await updateEvent({
                    ...
                    event: {
                        ...
                        categoryId: "65b9eca63bd136e699a4929f"
                    },
                    path: `/events/${eventId}`
                })
                if(updatedEvent){
                    ...
                    render={({ field }) => (
                        <FormItem className="w-full ">
                            <FormControl className="h-72">
                                <Textarea placeholder="Description" {...field} className="input-field"/>
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                                            ...
                                            <FormItem >
                                                <FormControl>
                                                    <div className="flex items-center">
                                                        ...
                                                        <Checkbox onCheckedChange={field.onChange} checked={field.value} id="isFree" className="mr-2 h-5 border-pri"/>
                                                    </div>
                                                </FormControl>
